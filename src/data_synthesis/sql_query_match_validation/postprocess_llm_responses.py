...
def parse_args():
    ...
    parser.add_argument("--input_dir", type=str, default="output/llm_raw/static_requirement_matching",
                        help="LLM 原始响应的输入目录（会递归读取所有 .jsonl 文件）")
    parser.add_argument("--output_file", type=str, default="output/postprocessed/static_requirement_matching/sql_responses.jsonl",
                        help="清洗后结果的输出文件路径")
