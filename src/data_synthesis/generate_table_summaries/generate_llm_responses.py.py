...
def parse_args():
    ...
    parser.add_argument("--prompt_file", type=str, default='output/prompt/table_summary_prompts.jsonl',
    ...
    parser.add_argument("--prompt_field", type=str, default="prompt_context.filled",
