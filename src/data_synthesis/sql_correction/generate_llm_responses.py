...
def parse_args():
    ...
    parser.add_argument("--model_name", type=str, default="Qwen3-Coder-30B-A3B-Instruct",
                        help="要调用的模型名称")
    ...
    parser.add_argument("--prompt_field", type=str, default='validation_error.correction_prompt',
